...
check:
	$(PY) -m py_compile little_hawk_cli.py little_hawk_transplant.py little_hawk_transplant_qwen.py transplants/smollm.py transplants/qwen.py api/server.py cli/main.py
